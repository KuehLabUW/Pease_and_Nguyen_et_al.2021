function [fitresult, gof] = gauss4_2D(xrange, yrange, nry, param)
...
equation = [eq{1} '+' eq{2} '+' eq{3} '+' eq{4}];    % full equation with four terms
...
%ft(A1,A2,A3,A4,mx1,mx2,mx3,mx4,my1,my2,my3,my4,r1,r2,r3,r4,sx1,sx2,sx3,sx4, sy1,sy2,sy3,sy4,x,y)
StartPoint = [500 500 500 500 
    param.ylow_m param.yhi_m param.ylow_m param.yhi_m 
    param.rlow_m param.rlow_m param.rhi_m param.rhi_m 
    0 0 0 0 
    param.ylow_s, param.yhi_s param.ylow_s param.yhi_s 
    param.rlow_s param.rlow_s param.rhi_s param.rhi_s]';

Upper = [5000 5000 5000 5000
    param.ylow_m+mwiggle param.yhi_m+mwiggle param.ylow_m+mwiggle param.yhi_m+mwiggle 
    param.rlow_m+mwiggle param.rlow_m+mwiggle param.rhi_m+mwiggle param.rhi_m+mwiggle 
    0.8 0.8 0.8 0.8
    param.ylow_s+swiggle param.yhi_s+swiggle param.ylow_s+swiggle param.yhi_s+swiggle  
    param.rlow_s+swiggle param.rlow_s+swiggle param.rhi_s+swiggle param.rhi_s+swiggle]';
