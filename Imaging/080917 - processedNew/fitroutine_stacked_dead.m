...
load('RoundCells_Deadp21082117.mat')
...
tbinhigh = tbinlow+9-eps;   % these are the well positions
...
for i = 1:length(tbinlow)
    ...
    [fitresult gof] = gauss2_2Dfixedp21(xrange, yrange, nry, param);
...
save('pop_fractions_EV072017.mat','tmean','fA1','fA2','ftotal');
