...
CIEVDead = 0.1158 - fitResultEVDead.kd;
CIcMycDead = 0.1243 - fitResultcMycDead.kd;
%%%%%%%%
figure(1)
hold on
...
cMycDead = fitResultcMycDead.kd * pr(2);
EVDead   = fitResultEVDead.kd * pr(1);
CIEVDead = CIEVDead*pr(1);
CIcMycDead = CIcMycDead*pr(2);
display(cMycDead)
display(EVDead)
%%
