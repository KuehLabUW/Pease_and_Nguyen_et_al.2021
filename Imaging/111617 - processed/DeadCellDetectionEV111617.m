%Well pos 15 41 50 39 56 36 109 
% This is is timestamp, each frame is 0.5 hr
A(1).EV = [0 6 3 0.5 2 0.5];
A(2).EV = [0 2];
A(3).EV = [12 15];
A(4).EV = [30.5 4 0.5 0.5 0.5 1];
A(5).EV = [1 2.5];
A(6).EV = [5 7.5 0.5 1.5 1 5 0.5 1];
A(7).EV = [21.5 7.5];
A(8).EV = [15 15];
A(9).EV = [25.5 4.5];
A(10).EV = [0 3 0.5 2];
A(11).EV = [2 6 3.5 7];
A(12).EV = [16.5 17.5];
A(13).EV = [25 2 0.5 9.5];
A(14).EV = [29 6.5];
A(15).EV = [30.5 4 0.5 2.5 0.5 0.5];
A(16).EV = [46 7.5 1 0.5];
A(17).EV = [0 8.5];
A(18).EV = [7.5 11];
A(19).EV = [27.5 1.5];
A(20).EV = [44.15 14.5];
A(21).EV = [47 12];
A(22).EV = [2.5 1 0.5 0.5 0.5 8 0.5 2];
A(23).EV = [9.5 5.5];
A(24).EV = [20 4.5 0.5 3 0.5 1.5 0.5 7];
A(25).EV = [33.5 13.5 0.5 2.5];
A(26).EV = [28.5 1 1.5 3.5 0.5 1];
A(27).EV = [10 3.5 0.5 19];
A(28).EV = [38.5 20.5];
A(29).EV = [45 0.5 0.5 1.5 0.5 4.5];
A(30).EV = [1 1 0.5 5];
...
for j = 1:numel(Kdlist) %loop through candidate kd
    ...
    for l = 1:numel(XData) %start at each x value - generate list of model dead cell
        SUM = 64*Prob(XData(l)); %this is to account for the initial number of dead cells;
        % there is a delay of 24 frames (12 hrs)
...
%% seems Kd = 0.0095 is best here plot model vs real data
DeadCellModel = zeros(0,numel(XData));
    for l = 1:numel(XData) %start at each x value - generate list of model dead cell
        SUM = 64*Prob(XData(l)); %this is to account for the initial number of dead cells
        for x = 1:XData(l) %summation
           SUM = SUM + 0.0095*CelltotalEVLive(x)*Prob(XData(l)-x); 
        end
        DeadCellModel(l) = SUM;
    end
figure(2)
scatter(XData,CelltotalEVDead);
hold on
