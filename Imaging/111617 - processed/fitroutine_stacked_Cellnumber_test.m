...
load('RoundCells_EV111617RatioDead.mat')
...
tbinlow = [0 20 40 60 80 100];   % these are the well positions
...
corr1 = [fdata.corr1];
corr2 = [fdata.corr2];
%numcellEV = [fdata.CellNum];
numcellEV = Celltotal;
tnumber   = [0:1:numel(Celltotal)-1];

ftotale = fA1+fA2e;
plot(tmean, fA1./ftotale,'ko'); hold on;
plot(tmean, fA2e./ftotale,'go');
figure(100);
...
%save('CellNumber_EV111617.mat','tmean','numcellEV');
%save('pop_fractions_EV111617.mat','tmean','fA1','fA2e','ftotale');
