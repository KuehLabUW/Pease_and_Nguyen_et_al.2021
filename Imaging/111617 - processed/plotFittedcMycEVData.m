...
[fitResultcMycDead,gofcMycd] = fitDeadExpo(tmean'*0.5+12, numcellDeadcMyc',S(2),A(2),yo(2));
[fitResultEVDead,gofEVd] = fitDeadExpo(tmean'*0.5+12, numcellDeadEV',S(1),A(1),yo(1));
