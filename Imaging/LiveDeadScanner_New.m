clear
cd('C:\Users\Sam Nguyen\Documents\MATLAB\Imaging\082117 - processed\pos 598')
load('imgf_0020.mat')
...
if numel(LiveDeadCheatSheet) ~= numel(r)
    ...
    save([outdir '082117Pos598T20.mat'],'Cell') % save as ({expdate}Pos{well position}T{timepoint})
end
