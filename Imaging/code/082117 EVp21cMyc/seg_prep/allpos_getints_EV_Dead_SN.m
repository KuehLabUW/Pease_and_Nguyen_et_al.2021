...
for p = 1:255    % loop over all the stage positions
...
for t = 1:T    % loop through all timepoints
    ...
    obj = [];
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    for p = 1:255   % loop through all stage positions
...
gatenames = {'ALL'};
save([dirname 'segtracksint_EV082117RatioDead.mat'],'objects','gatenames');
