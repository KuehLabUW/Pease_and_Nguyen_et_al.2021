...
for p = 143:527    % loop over all the stage positions
...
for t = 1:T    % loop through all timepoints
    ...
    obj = [];
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    for p = 144:527   % loop through all stage positions
        ...
        for i = 1:length(obj1)   % loop through all objects
            ...
            obj1(i).data.logYFP_Area = obj1(i).data.logYFP/obj1(i).data.area ;
            obj1(i).data.logRFP_logArea = obj1(i).data.logRFP-log10(obj1(i).data.area) ;
            obj1(i).data.logRFP_Area = obj1(i).data.logRFP/obj1(i).data.area ;
...
gatenames = {'ALL'};
save([dirname 'segtracksint_Feb082117Ratio.mat'],'objects','gatenames');
