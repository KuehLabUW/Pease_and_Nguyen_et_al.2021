% agglomerate
YFPoffset = 2000; %used to be 1000
RFPoffset = 2000; %used to be 2000
P = 795;
Pcustom = 255;
Pinitial = 1;
dirname = '/data/phnguyen/Imaging/RawData/082117 - processed/';

for p = Pinitial : Pcustom    % loop over all the stage positions
...
for t = 1:T    % loop through all timepoints
    t
    obj = [];
    for p = Pinitial:Pcustom   % loop through all stage positions
        ...
        for i = 1:length(obj1)   % loop through all objects
            ...
            obj1(i).data.logYFP_logArea = obj1(i).data.logYFP-log10(obj1(i).data.area) ;
            obj1(i).data.logRFP_logArea = obj1(i).data.logRFP-log10(obj1(i).data.area) ;
            obj1(i).data.logYFP_logRFP = obj1(i).data.logYFP/obj1(i).data.logRFP;
            obj1(i).data.logYFPRFP = obj1(i).data.logYFP-obj1(i).data.logRFP;
...
gatenames = {'ALL'};
save([dirname 'segtracksint_FebEV082117Ratio.mat'],'objects','gatenames');
