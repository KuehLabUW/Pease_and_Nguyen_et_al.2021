...
for p = 394:664    % loop over all the stage positions
...
for t = 1:T    % loop through all timepoints
    ...
    obj = [];
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    for p = 394:664   % loop through all stage positions
...
gatenames = {'ALL'};
save([dirname 'segtracksint_cMyc082117RatioDead.mat'],'objects','gatenames');
