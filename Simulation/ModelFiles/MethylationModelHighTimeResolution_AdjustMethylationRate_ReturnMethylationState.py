...
def doSimulation(CycleTime,alpha1,beta1,alpha2,beta2,L,TF,LT): #LT is the number of fixed nucleosome
    ...
    result=[]
    for i in xrange(0,40/t,1): #simulate 5000/t cell cycle/total of 9990 points
        if i == 0:
...
def writeCSV(ResultMatrix,alpha,beta,CellCycle):
    ...
    with open('HighResRawAlpha{}Beta{}Cycle{}short.csv'.format(alpha,beta,CellCycle),'w') as mycvsfile: #open up 'mydata.csv' for reading and pass it up to a variable
