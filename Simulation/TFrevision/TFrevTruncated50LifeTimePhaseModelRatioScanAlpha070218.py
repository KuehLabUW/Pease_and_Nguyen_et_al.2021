...
def writeCSV(ResultMatrix,AlphaON,AlphaOFF,LambdaON,DeltaOFF,K_on,K_off,TF,MCu,Cycle):
    with open('MCu{}CompTF{}Trun446F0.825LifeTimePhaseKon{}Koff{}AlphaON{}AlphaOFF{}LambdaON{}DeltaOFF{}Cycle{}.csv'.format(MCu,TF,K_on,K_off,AlphaON,AlphaOFF,LambdaON,DeltaOFF,Cycle),'w') as mycvsfile:
...
RepeatArray = list(numpy.arange(1,26,1))
